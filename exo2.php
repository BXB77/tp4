  ...
  <body>
    ...
    <table border=1>
      ...
      <?php
        ...
        $resume=$_GET["resume"];
        $annee=$_GET["annee"];
        $idMes=mysqli_query($link,"select idMes from Film F join Artiste A where idArtiste=idMes and A.nom=".$realisateur);
        $sql="INSERT INTO Film(titre,genre,codePays,idMes,resume,annee) VALUES ('".$nom."','".$genre."','".$pays."','".$idMes."','".$resume."','".$annee."')";
